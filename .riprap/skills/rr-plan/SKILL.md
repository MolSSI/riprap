...
A complete example requirements file is available at `.riprap/skills/rr-plan/bse.md`. Read this file.
...
and Gherkin scenarios. These IDs are managed by `.riprap/skills/rr-plan/rqm.sh`.
...
```
.riprap/skills/rr-plan/rqm.sh stamp <path-to-file>
...
Read `.riprap/skills/rr-plan/local.md` and follow any instructions it contains. Where those
