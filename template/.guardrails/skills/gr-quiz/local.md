# Local Extensions to the gr-quiz Skill
...
Instructions added below extend the gr-quiz skill. Where they conflict with the
skill's built-in instructions, this file wins.

Examples of instructions you might add:

<!--
- Focus questions on the numerical routines under `src/solver/`.
- Ask two questions per quiz instead of one.
-->
